...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        results = model.predict(source=im, conf=conf_thres, iou=iou_thres)
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # ROI_MIN = int(FRAME_HEIGHT*0.10)   #change the ROI dimension according to your camera angle
            # ROI_MAX = int(FRAME_HEIGHT*0.70)
        ...
        # cv2.line(im0, (5,ROI_MIN), (5, ROI_MAX), (0,255,0), 1)
        # cv2.line(im0, (FRAME_WIDTH - 5,ROI_MIN), (FRAME_WIDTH - 5, ROI_MAX), (0,255,0), 1)
        # cv2.line(im0, (0,ROI_MIN), (FRAME_WIDTH, ROI_MIN), (0,255,0), 1)
        # cv2.line(im0, (0,ROI_MAX), (FRAME_WIDTH, ROI_MAX), (0,255,0), 1)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'my_coco.pt', help='model path(s)')
